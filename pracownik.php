...
.lekcja-box {
    ...
    max-width: 1000px;
    margin-top: 15px;
    word-wrap: break-word;      /* łamanie długich słów */     /* zachowanie nowych linii z treści */
}
...
<div class="col-md-2 sidebar">
    <a href="pracownik.php"><h4>📚 E-learning</h4></a>
    <hr>

    <?php
    // Pobranie wszystkich lekcji z bazy
    ...
    <!-- PANEL COACHA / PRACOWNIKA -->
    <?php if($_SESSION['rola'] === 'coach'): ?>
        <h5>Panel Coacha</h5>
        <a href="dodaj_lekcje.php">➕ Dodaj lekcję</a>
        <a href="dodaj_test.php">➕ Dodaj test</a>
        <a href="wyniki_prac.php">📊 Wyniki pracowników</a>
        <hr>
    <?php elseif($_SESSION['rola'] === 'pracownik'): ?>
        <h5>Panel pracownika</h5>
        <a href="test.php">📋 Testy</a>
        <hr>
    <?php endif; ?>
